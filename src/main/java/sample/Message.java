    ...
    public static void dialog() {
        ...
        switch (action) {
            ...
            case ("4"):
                ...
                int ncost = PriceCounter.generatePrice(hotel, trip, shopping);
                user = new Tour(firstName, lastName, choice.get(destination), ncost, choice.get(hotel), choice.get(trip), choice.get(shopping));
